...
if [ "$1" == "-o" ]; then
    ...
    riscv64-unknown-elf-gcc -mabi=ilp32 -march=rv32i -O0 -nostartfiles -nostdlib -mno-strict-align -mcmodel=medany -fno-builtin -T ../libs/linker.ld -o "$output_file" ../libs/start.s "$@"
else
